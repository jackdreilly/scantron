...
class MarkdownFormField extends StatefulWidget {
  ...
  @override
  MarkdownFormFieldStateObject createState() => MarkdownFormFieldStateObject();
}

class MarkdownFormFieldStateObject extends State<MarkdownFormField> {
  // internal parameter
